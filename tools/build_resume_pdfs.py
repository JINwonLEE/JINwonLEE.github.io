...
def variants() -> tuple[ResumeVariant, ...]:
    ...
    return (
        ResumeVariant(
            ...
            language="en",
            professional_title="AI Platform & Reliability Engineer",
            summary=(
                "AI platform and reliability engineer with about eight years of experience delivering governed agent applications, cloud platforms, and user-facing services into production.",
                "Builds and operates systems across agent runtime integration, delivery automation, access control, observability, incident response, and production stabilization.",
            ),
            evidence=(
                ...
                "UK rollout, incident response, and stabilization for a global B2C generative AI service",
            ),
            skills=(
                ("Agent Platform", "AWS EKS, agent runtime integration, self-service delivery, automatic domains, existing LLM Gateway API integration"),
                ("Reliability", "Grafana, Prometheus, OpenTelemetry, incident response, rollout stabilization, high availability, auto-scaling"),
                ("Software & Delivery", "Python, Bash, Linux, Kubernetes Operators, ArgoCD, GitHub Actions, GitOps, Helm/Helmfile"),
                ("Security & Governance", "Authentication, authorization, platform security controls, policy enforcement, enterprise governance"),
            ),
        ...
        ResumeVariant(
            ...
            language="ko",
            professional_title="AI 플랫폼 & 신뢰성 엔지니어",
            summary=(
                "약 8년 동안 거버넌스형 Agent App, 클라우드 플랫폼 및 사용자 대상 서비스를 프로덕션까지 전달해 온 AI 플랫폼·신뢰성 엔지니어입니다.",
                "Agent 런타임 연동, 배포 자동화, 접근 제어, 관측, 장애 대응 및 프로덕션 안정화를 설계부터 운영까지 직접 이어갑니다.",
            ),
            evidence=(
                "AWS EKS 기반 거버넌스·셀프서비스 AX App 배포 플랫폼",
                "30,000명 임직원 대상 전사 AI 서비스 프로덕션 신뢰성",
                "글로벌 B2C 생성형 AI 서비스 UK 출시·장애 대응·초기 안정화",
            ),
            skills=(
                ("Agent 플랫폼", "AWS EKS, Agent 런타임 연동, 셀프서비스 배포, 도메인 자동 발급, 기존 LLM Gateway API 연동"),
                ("신뢰성", "Grafana, Prometheus, OpenTelemetry, 장애 대응, 출시 안정화, 고가용성, 오토스케일링"),
                ("소프트웨어 & 배포", "Python, Bash, Linux, Kubernetes Operator, ArgoCD, GitHub Actions, GitOps, Helm/Helmfile"),
                ("보안 & 거버넌스", "인증, 인가, 플랫폼 보안 통제, 정책 적용, 엔터프라이즈 거버넌스"),
            ),
            experiences=korean_experiences(),
            projects=(
                Project(
                    "사내 AX Agent Platform",
                    "AWS EKS에서 런타임 조정, 도메인 자동 발급, 인가된 사용자 전용 접근 및 기존 사내 LLM Gateway API 연동을 제공하는 거버넌스형 AX App 배포 플랫폼을 구축했습니다.",
                ),
                Project(
                    "관측 환경 & 릴리스 신뢰성",
